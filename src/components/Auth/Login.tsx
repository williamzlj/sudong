    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 p-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-gray-400 text-sm mt-6">
          树洞是一个安全的匿名聊天空间，您可以放心倾诉心事。你的隐私很安全，我们不会储存你的密码和聊天信息，所有聊天记录仅保存在本地浏览器管理的IndexedDB数据库中，服务器端不保存用户的任何数据。请及时导出和保存数据！使用时请关闭无痕浏览模式，因为无痕浏览模式退出时每次都会清空缓存，清空浏览器缓存时会清空数据库！数据丢失后无法恢复！数据有意外丢失的风险，请不要用来做重要的事项的记录！<br></br>本软件由张亮军开发（张亮数理化 无锡·海岸城）。2026.5
        </p>
      </div>
    </div>
  );
