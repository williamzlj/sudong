...
export const InputBox = ({ onSend, onSave, hasMessages, disabled = false, isDarkMode = false, isBanned = false }: InputBoxProps) => {
  ...
  return (
    <div className={`border-t px-4 py-3 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
      {selectedImage && (
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex-1 flex items-center rounded-full px-4 py-2">
          <textarea
            ...
            rows={1}
            className={`flex-1 py-2 outline-none resize-none ${
              isDarkMode
